...
@Component({
  selector: 'app-withings-instructions',
  standalone: true,
  imports: [CommonModule, FormsModule],
  template: `
    <div class="withings-instructions">
  ...
  `,
  styleUrls: ['./withings-instructions.component.scss']
})
export class WithingsInstructionsComponent {
  callbackUrl = signal('')
  copied = signal(false)
